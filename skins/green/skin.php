...
<div align="center">
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="660" height="24" align="left" valign="bottom" background="<?php echo $skindir; ?>tm.jpg" bgcolor="#FFFFFF"><img src="<?php echo $skindir; ?>t1.jpg" width="649" height="24" /></td>
    ...
    <tr>
      ...
      <td width="660" height="182" align="left" valign="top" bgcolor="#FFFFFF"><img src="<?php echo $skindir; ?>l1.jpg" width="649" height="182" /></td>
    ...
    <tr>
      ...
      <td width="660" bgcolor="#FFFFFF"><?php require "mainform.php"; ?></td>
    ...
    <tr>
      ...
      <td width="660" height="23" background="<?php echo $skindir; ?>bm.jpg" bgcolor="#FFFFFF">&nbsp;</td>
