...
<tr><td height="45" align="center" valign="middle"  class="ErrTab"><br>'.$mail_body.'<br><br><hr><br>'.$mail_body2.'<br><br></td></tr>
    ...
    // отсылка по почте
if ($mail_event == 'standart') $mail_message = '<html><head><title>mail robot message</title>
<style type="text/css">
<!--
td.TableTitle {
...
if ($encoding == 'cp1251') $mail->Is1251();         	// выбор кодировки
else $mail->IsUTF8();

switch ($mail_method) {                          	// выбор метода отправки
case 'mail':
